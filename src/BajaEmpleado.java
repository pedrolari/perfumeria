...
public class BajaEmpleado extends JInternalFrame implements ActionListener{
	...
	BajaEmpleado(){
		...
		principal.setBorder(BorderFactory.createTitledBorder(BorderFactory.createLineBorder(new Color(41, 53, 65), 1), "BAJA EMPLEADO", TitledBorder.LEFT, TitledBorder.TOP, new Font(null, Font.BOLD, 25), new Color(41, 53, 65)));
