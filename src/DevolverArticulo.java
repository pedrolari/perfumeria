...
public class DevolverArticulo extends JInternalFrame {
	...
	DevolverArticulo (){
		...
		this.setBorder(BorderFactory.createTitledBorder(BorderFactory.createLineBorder(Color.GRAY), "Devolución Articulo", TitledBorder.LEFT, TitledBorder.TOP, new Font(null, Font.BOLD, 25), Color.GRAY));
